...
import { navItem3Config } from "./megaMenuConfig";
...
const NavItem3 = () => {
    ...
    const validColumns = filterValidColumns(navItem3Config.columns);
                        ...
                        <div className="custom-scrollbar mx-auto max-w-screen overflow-auto scroll-smooth px-4 transition-all 2xl:max-w-7xl">
                            <div className="flex flex-wrap">
                                ...
                                <RecommendationPicture
                                    {...navItem3Config.recommendationPicture}
