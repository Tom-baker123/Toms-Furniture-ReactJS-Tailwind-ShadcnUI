...
const AdminModalTemplate = () => {
    const { isOpen, modalContent, modalOptions, closeModal } = useAdminModal();
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    `relative z-[9999] max-h-full w-full overflow-auto rounded-lg px-3 pt-7 [scrollbar-width:_thin] md:px-10`,
