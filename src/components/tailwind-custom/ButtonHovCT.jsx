...
const ButtonHovCT = ({
    children,
    bgColor = "bg-black", // nền mặc định
    hoverBgColor = "bg-white", // nền hover luôn đổi
    ...
    return (
        ...
        >
            <span className={`relative z-10 transition-colors duration-300 group-hover:${hoverTextColor}`}>{children}</span>
            <span
