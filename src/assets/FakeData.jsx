...
export const NewArrivalsPicture = [
    ...
    {
        id: "1",
        ImageURL: "bottlegrinder.png",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
                price: "$65.00",
            },
        ],
    },
    {
        id: "2",
        ImageURL: "Curve-Coat-Rack-Shelf.png",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
    ...
    { id: "6", ImageURL: "Spoke-Sofa-Basic.png", info: [{ type: "SOFAS", proName: "Spoke Sofa Basic", price: "$3,289.00" }] },
    {
        id: "7",
        ImageURL: "Turn-Table-Mono.png",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
...
export const HotItemsPicture = [
    ...
    {
        id: "1",
        ImageURL: "HotItems/bottlegrinder.png",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
    ...
    {
        id: "3",
        ImageURL: "HotItems/LevitatePendant.jpg",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
    ...
    {
        id: "4",
        ImageURL: "HotItems/CandleHolder.jpg",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
    ...
    {
        id: "5",
        ImageURL: "HotItems/Brasilia-Ottoman.jpg",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
    ...
    {
        id: "6",
        ImageURL: "HotItems/Bow-Chair-Limited.jpg",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
    ...
    {
        id: "7",
        ImageURL: "HotItems/Bar-Stool-Dark.jpg",
        info: [
            {
                type: "ACCESSORIES",
                proName: "Bottle Grinder",
